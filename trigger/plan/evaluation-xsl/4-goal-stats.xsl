...
<xsl:stylesheet 
  ...
  <xsl:template
    ...
    <xsl:copy>
      ...
      <xsl:variable name="successes" select="count(Objective[rsu:stats/@success='true'])"  />
      <xsl:variable name="failures" select="count(Objective[rsu:stats/@success='false'])"  />
      <xsl:variable name="blanks" select="count(Objective[rsu:stats/@success=''])"  />
